...
const CheckOutSucess = () => {
  ...
  useEffect(() => {
    axios.delete(`https://quickfood-server.onrender.com/CartReset/${email}`)
    ...
    const fetchOrderData = async () => {
      try {
        ...
        const response = await axios.get(`https://quickfood-server.onrender.com/SuccessfulPayment/api/stripe/order?session_id=${sessionId}`); // Replace '/api/stripe/order' with your backend endpoint for fetching order data
