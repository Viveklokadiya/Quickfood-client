...
const router = createBrowserRouter([
    {
      ...
      children: [
        ...
        },
        {
          path: "/orders/",
          element: <Orderview/>,
          loader: ({params}) => fetch(`https://quickfood-server.onrender.com/orders/?orderId=${params.id}`)
        }, 
    ...
    },
    {
      ...
      children: [
        ...
        }, 
        {
          ...
          path: "update-menu/:id",
          element: <UpdateMenu/>,
          loader: ({params}) => fetch(`https://quickfood-server.onrender.com/menu/${params.id}`)
        }
      ]
    }
  ]);
